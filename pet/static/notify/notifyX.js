...
$(document).ready(function () {
    // alert(nfListSelector);
    // alert(markNotificationSelector);
    var btn = $('.notification');
    // alert(btn.length);
    $('.notification').delegate(markNotificationSelector, 'click', function () {
...
$(document).ready(function () {
    // alert(markAllNotificationSelector);
    // alert(markAllNotificationUrl);
...
$(document).ready(function () {
    ...
    $('.notification').delegate(deleteNotificationSelector, 'click', function () {
